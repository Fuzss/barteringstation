 ...
 */
public class PiglinHeadModelRenderer implements ResourceManagerReloadListener {
    public static final PiglinHeadModelRenderer INSTANCE = new PiglinHeadModelRenderer();
    public static final ResourceLocation PIGLIN_ITEM_MODEL_LOCATION = BarteringStation.id("item/piglin_head");
    ...
    static final ModelLayerFactory LAYER_REGISTRY = ModelLayerFactory.from(BarteringStation.MOD_ID);
    ...
    public void onResourceManagerReload(ResourceManager resourceManager) {
        this.piglinHeadModel = ClientAbstractions.INSTANCE.getBakedModel(PIGLIN_ITEM_MODEL_LOCATION);
    }
    ...
    public void renderPiglinHeadGuiModel(int posX, int posY, int blitOffset, SkullModelBase skullModel) {
        ...
        PiglinHeadModelRenderer.renderItemLikeGuiModel(posX, posY, blitOffset, skullModel, rendertype, this.piglinHeadModel);
    }
