...
public class BarteringStationBlockEntity extends BaseContainerBlockEntity implements WorldlyContainer {
    ...
    private static List<Piglin> findNearbyPiglins(Level level, BlockPos pos) {
        ...
        final int horizontalRange = BarteringStation.CONFIG.get(ServerConfig.class).horizontalRange;
        final int verticalRange = BarteringStation.CONFIG.get(ServerConfig.class).verticalRange;
