...
public class PiglinHeadModelHandler {
    ...
    private void dissolve() {
        if (this.piglinHeadModel == null) {
            UnbakedModel unbakedModel = ForgeModelBakery.instance().getModelOrMissing(PIGLIN_ITEM_MODEL_LOCATION);
            this.piglinHeadModel = unbakedModel.bake(ForgeModelBakery.instance(), ForgeModelBakery.instance().getSpriteMap()::getSprite, BlockModelRotation.X0_Y0, PIGLIN_ITEM_MODEL_LOCATION);
        }
    }
